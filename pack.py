...
def build_shell():
    ...
    gradlew_path = os.path.join(SHELL_PROJECT_DIR, "gradlew.bat")
    gradlew = os.path.abspath(gradlew_path) if os.path.exists(gradlew_path) else "gradle"
...
def pack_apk(
    ...
    #bootstrap_lib_dir = os.path.join(SHELL_PROJECT_DIR, "app", "libs")
    ...
    print(f"Signature hash: {signature_hash.hex()}")
